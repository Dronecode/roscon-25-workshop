...
int main(int argc, char* argv[])
{
  ...
  /*
    The node shall register a mode executor to handle the formation control mode.
    The mode executor, once activated, will trigger a takeoff
    and then switch to the formation control mode.
  */
