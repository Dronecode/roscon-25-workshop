...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(path.join(pkg_share, 'launch', 'gz_world.launch.py')),
            launch_arguments={
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(path.join(pkg_share, 'launch', 'px4_vehicle.launch.py')),
            launch_arguments={
                'px4_autopilot_path': LaunchConfiguration('px4_autopilot_path'),
                'world': LaunchConfiguration('world'),
